...
export class ToastHelper {
    ...
    public static ToastJSX = (t:Toast, alertType:"success"|"error",message:string,jsx?:React.ReactNode):JSX.Element => {
        return (
    ...
    public static Success = (text:string) => {
        toast.custom((x)=>(ToastHelper.ToastJSX(x,"success",`${x.id}`)),{duration:5000});
