...
export function IconOpenFolder(props:IconPropsBase) {
    return <svg {...props} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
export function IconOpenFolder2(props:IconPropsBase) {
