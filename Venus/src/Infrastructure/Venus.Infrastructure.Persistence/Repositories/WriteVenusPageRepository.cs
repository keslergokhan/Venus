...
{
    public class WriteVenusPageRepository : WriteRepositoryBase<VenusPage> , IWriteVenusPageCmsRepository
    {
        public WriteVenusPageRepository(VenusContext db) : base(db)
        {
        }
    }
}
